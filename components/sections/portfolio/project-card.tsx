...
export default function ProjectCard({ project, index, tButtons, tLabels, tProjects }: ProjectCardProps) {
  ...
  return (
    ...
    >
      {/* Card Image Area */}
      <div className={`aspect-[4/3] ${project.color} relative border-2 border-black overflow-hidden cursor-pointer`}>
        ...
        {/* Hover overlay — description + metrics + CTA */}
        ...
        {/* Category badge — bottom-left, visible by default, hidden on hover */}
        <div className="absolute bottom-3 left-3 z-10 md:opacity-100 md:group-hover:opacity-0 transition-opacity duration-200">
      ...
      <div className="mt-4 space-y-2">
        ...
        {/* Mobile: description + metrics + link (hover overlay not accessible on touch) */}
