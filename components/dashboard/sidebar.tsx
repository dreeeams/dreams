...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#1f1f1f] text-white flex flex-col min-h-screen">
      {/* Logo */}
      ...
      <div className="p-3 border-t border-gray-800">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-gray-400 hover:bg-gray-800/50 hover:text-red-400 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
