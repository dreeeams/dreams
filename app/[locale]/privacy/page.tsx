        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12 bg-gray-50 p-6 border-2 border-black">
              ...
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  ...
                  <strong> LF DREAMS S.A.S.</strong> identificada con NIT 902.022.315-1, en su calidad de Responsable del
                  Tratamiento de Datos Personales, informa:
                </p>
                <p>
                  <strong>Finalidad del Tratamiento:</strong> Los datos personales recopilados a través de este formulario
                ...
                <p>
                  <strong>Derechos del Titular:</strong> Como titular de los datos personales, usted tiene derecho a:
                ...
                <p>
                  <strong>Mecanismos de Consulta:</strong> Puede consultar sus datos personales o ejercer sus derechos
                ...
                <p>
                  <strong>Autorización:</strong> Al suministrar sus datos personales a través de este formulario y hacer clic
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-6 border-l-4 border-brand pl-4">
              ...
              {/* Section 1 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">1. IDENTIFICACIÓN DEL RESPONSABLE</h3>
              ...
              {/* Section 2 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">2. OBJETO Y ALCANCE</h3>
              ...
              {/* Section 3 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">3. DEFINICIONES</h3>
                <div className="text-gray-700 leading-relaxed space-y-3">
                  ...
                  <p>
                    <strong>Dato Sensible:</strong> Aquellos que afectan la intimidad del Titular o cuyo uso indebido puede
              ...
              {/* Section 4 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">4. CATEGORÍAS DE DATOS TRATADOS Y FINALIDADES</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.1. Datos de Clientes (Personas Naturales)</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    ...
                    <p className="text-gray-700 mb-2"><strong>Finalidades:</strong></p>
                    ...
                    <p className="text-gray-700 mt-2"><strong>Tiempo de conservación:</strong> Durante la vigencia de la
                    relación comercial y hasta 10 años después para efectos tributarios y de prescripción legal.</p>
                  </div>

                  {/* 4.2 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.2. Datos de Clientes Empresariales (B2B)</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-1">
                    ...
                    <p className="text-gray-700 mt-2"><strong>Tiempo de conservación:</strong> Durante la vigencia del
                    contrato y hasta 10 años después conforme a la legislación tributaria colombiana.</p>
                  </div>

                  {/* 4.3 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.3. Datos de Empleados y Colaboradores</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-1">
                  ...
                  {/* 4.4 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.4. Datos de Candidatos a Empleo</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-1">
                      <li>Datos de identificación y contacto</li>
                    ...
                    <p className="text-gray-700 mt-2"><strong>Tiempo de conservación:</strong> Hasta 1 año después del
                  ...
                  {/* 4.5 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.5. Datos de Proveedores</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-1">
                  ...
                  {/* 4.6 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.6. Datos de Visitantes del Sitio Web</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-1">
                      <li>Dirección IP</li>
                    ...
                    <p className="text-gray-700 mt-2"><strong>Tiempo de conservación:</strong> Las cookies se conservan
                  ...
                  {/* 4.7 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.7. Datos de Asistentes a Eventos</h4>
                    <p className="text-gray-700 mb-2"><strong>Datos recopilados:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-1">
                    ...
                    <p className="text-gray-700 mt-2"><strong>Tiempo de conservación:</strong> 1 año después de la
                    realización del evento.</p>
                  </div>

                  {/* 4.8 */}
                  <div className="bg-gray-50 p-4 border-l-4 border-brand">
                    <h4 className="font-bold text-lg mb-2">4.8. Datos de Menores de Edad</h4>
                    ...
                    <p className="text-gray-700 mb-2"><strong>Finalidades limitadas:</strong></p>
                    <ul className="list-disc pl-6 text-gray-700 space-y-1">
                    ...
                    <p className="text-gray-700 mt-2"><strong>Prohibiciones expresas:</strong> No se podrá utilizar
              ...
              {/* Section 5 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">5. DERECHOS DE LOS TITULARES</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    <strong>a) Conocer, actualizar y rectificar sus datos personales</strong> frente a LF DREAMS S.A.S.
                  ...
                  <p>
                    <strong>b) Solicitar prueba de la autorización otorgada</strong> a LF DREAMS S.A.S., salvo cuando
                    expresamente se exceptúe como requisito para el Tratamiento.
                  </p>
                  <p>
                    <strong>c) Ser informado por LF DREAMS S.A.S.,</strong> previa solicitud, respecto del uso que le ha
                    dado a sus datos personales.
                  </p>
                  <p>
                    <strong>d) Presentar ante la Superintendencia de Industria y Comercio (SIC)</strong> quejas por
                  ...
                  <p>
                    <strong>e) Revocar la autorización y/o solicitar la supresión del dato</strong> cuando en el Tratamiento
                  ...
                  <p>
                    <strong>f) Acceder en forma gratuita</strong> a sus datos personales que hayan sido objeto de Tratamiento.
                  </p>
                </div>
              </div>
              ...
              {/* Section 6 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">6. PROCEDIMIENTOS PARA EL EJERCICIO DE DERECHOS (PQRSD)</h3>
              ...
              {/* Section 7 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">7. SEGURIDAD DE LA INFORMACIÓN</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 8 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">8. TRANSFERENCIA Y TRANSMISIÓN DE DATOS</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  <strong>Encargados del Tratamiento:</strong> LF DREAMS S.A.S. podrá contratar proveedores de servicios
              ...
              {/* Section 9 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">9. COOKIES Y TECNOLOGÍAS DE RASTREO</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 10 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">10. TRATAMIENTO DE DATOS SENSIBLES</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 11 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">11. VIGENCIA Y MODIFICACIONES</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 12 */}
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">12. LEY APLICABLE Y JURISDICCIÓN</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              {/* Contact Section */}
              <div className="bg-brand/10 p-6 border-2 border-black">
                <h3 className="text-xl font-bold mb-4">INFORMACIÓN DE CONTACTO</h3>
                <div className="text-gray-700 space-y-2">
                  <p><strong>Responsable del Tratamiento:</strong> LF DREAMS S.A.S.</p>
                  <p><strong>NIT:</strong> 902.022.315-1</p>
                  <p><strong>Domicilio:</strong> Bogotá D.C., Colombia</p>
                  <p><strong>Correo electrónico:</strong> <a href="mailto:info@dreeeams.com" className="text-brand hover:underline">info@dreeeams.com</a></p>
                  <p><strong>Sitio web:</strong> <a href="https://dreeeams.com" className="text-brand hover:underline" target="_blank" rel="noopener noreferrer">https://dreeeams.com</a></p>
                  <p className="mt-4"><strong>Asunto para ejercicio de derechos:</strong> "Protección de Datos Personales - PQRSD"</p>
                </div>
              </div>
            </section>
          </div>
